...
{
    /// <summary>
    /// Initializes the values, iterating through the stages defined by <see cref="AppInitializationStage"/>.
    /// The initialization service needs to directly initialize the values in the respective stages by calling their
    /// <see cref="IValue.InitializeValue(object, AppInitializationStage)"/> method, which will execute the value-specific initialization logic implemented in the concrete value class.
    /// </summary>
    ...
    /// </summary>
    AppInitializationStage CurrentStage { get; }
